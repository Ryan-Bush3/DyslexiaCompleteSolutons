...
const LandingPage: React.FC = () => {
  ...
  return (
    <main className="landing-page">
      {/* Hero Section */}
      <img src="/assets/women-child-reading.jpg" alt="Kids Studying" className="landing-img" />
      <section className="hero" id="home">
        <div className="hero-content">
          {/* <div className="hero-text">
          <h2 className="everyone-read">Where brilliant minds shine</h2>
          </div> */}
          <p className="hero-subtitle">
            Professional, evidence-based tutoring services designed specifically for students with dyslexia
          </p>
          <div className="hero-buttons">
            <button className="cta-button primary" onClick={handleContactUs}>Contact Us</button>
      ...
      <section className="cta-section">
        <div className="container">
          ...
          <button className="cta-button primary large" onClick={handleContactUs}>Contact Us</button>
        </div>
      </section>
    </main>
  );
